...
ASTNode *mkastnode(int op, ASTNode *left, ASTNode *mid, ASTNode *right, ASTVal32 val) {
    ASTNode *n;
...
const char *ast2str(int asttype)
{
    switch(asttype)
    {
        case(A_ADD): return "<A_ADD>";
        case(A_SUBTRACT): return "<A_SUBTRACT>";
        case(A_MULTIPLY): return "<A_MULTIPLY>";
        case(A_DIVIDE): return "<A_DIVIDE>";
        case(A_MOD): return "<A_MOD>";
        case(A_LOWTO): return "<A_LOWTO>";
        case(A_GREATTO): return "<A_GREATTO>";
        case(A_OR): return "<A_OR>";
        case(A_AND): return "<A_AND>";
        case(A_XOR): return "<A_XOR>";
        case(A_PLUS): return "<A_PLUS>";
        case(A_MINUS): return "<A_MINUS>";
        case(A_INV): return "<A_INV>";
        case(A_NOT): return "<A_NOT>";
        case(A_STMT): return "<A_STMT>";
        case(A_ASSIGN): return "<A_ASSIGN>";
        case(A_IDENT): return "<A_IDENT>";
        case(A_FUNCTION): return "<A_FUNCTION>";
        case(A_RETURN): return "<A_RETURN>";
        case(A_INTLIT): return "<A_INTLIT>";
        case(A_FLTLIT): return "A_FLTLIT";
        default: 
