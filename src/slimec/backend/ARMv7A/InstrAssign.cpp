#include <slimec/backend/ARMv7A/InstrAssign.h>
#include <iostream>
#include <sstream>
...
void InstrOp::moveIf(GeneralRegister rd, GeneralRegister rs, Predicate pred) {
    ...
    switch (pred) {
        ...
        case Predicate::SignedLE: {
            kind = InstrKind::MOVLE;
        } break;
        case Predicate::SignedLT: {
            kind = InstrKind::MOVLT;
        } break;
        case Predicate::SignedGE: {
            kind = InstrKind::MOVGE;
        } break;
        case Predicate::SignedGT: {
